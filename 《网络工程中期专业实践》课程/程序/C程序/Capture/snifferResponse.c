...
#define LOCKFILE "/var/run/snifferResponse.pid"                      //锁文件路径
#define LOCKMODE (S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH)      //打开锁文件模式
#define REQUESTFILE "/home/ricardo/桌面/Capture/response.pcap" //请求数据包文件路径  绝对路径
...
int main(int argc, char **argv)
{
    ...
    // pcap_compile()
    char filter_exp[] = "ip and (tcp dst port 80) and ((tcp[32:4] = 0x47455420) or (tcp[48:4] = 0x504f5354))"; /* filter expression [3] */
