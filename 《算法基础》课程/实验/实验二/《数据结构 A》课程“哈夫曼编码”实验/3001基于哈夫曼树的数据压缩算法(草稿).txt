...
void Select(HuffmanTree HT, int len, int& s1, int& s2)
{
	...
	int temp;
	temp = HT[i].weight;
	HT[i].weight = 0x3f3f3f3f;//将原值存放起来，赋予最大值，防止选择s2时s1被重复选择
...
void CreatHuffmanCode(HuffmanTree HT, HuffmanCode& HC, int n)//(HuffmanTree &HT！！！×
