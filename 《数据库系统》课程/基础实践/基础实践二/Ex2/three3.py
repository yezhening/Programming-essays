...
sql = """
    ...
    FROM SH
"""
row = connectionPool.exec_sql(sql)
...
sql = """
    ...
    DELETE
    FROM SH
    WHERE cno='S001' AND sno='0591'
"""
# 无返回结果集,报错:pymssql.OperationalError: Statement not executed or executed statement has no resultset
# 捕获异常并忽略
try:
    row = connectionPool.exec_sql(sql)
